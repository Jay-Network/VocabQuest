...
- Quiz Mode (Premium): Multiple-choice recognition quizzes that test your recall under time pressure.
...
- Spend coins in the Shop on power-ups and cosmetics
- Track your XP, level, and daily streaks
- Compete with yourself through progress stats and combo multipliers

BUILT FOR REAL LEARNERS
- 10,000 words with 17,000+ example sentences
- Full audio pronunciation for every word
- CEFR levels A1–C2 for structured progression
- Offline-capable — learn anywhere without internet
- Clean, modern design with light and dark themes

PREMIUM FEATURES
Upgrade to Premium to unlock the full experience:
- All 10,000 words (Free: 500 words)
- Quiz mode
- Unlimited daily reviews (Free: 20/day)
...
## Tags/Keywords
english, vocabulary, eigo, flashcards, spaced repetition, ESL, TOEFL, language learning, quiz, education, gamification, CEFR, word games, study, test prep

## Contact Details
- Developer: JWorks
- Email: support@jworks-ai.com
...
- User interaction: Yes (feedback submission only - no user-to-user chat)
- Shares location: No
- Contains ads: No
- In-app purchases: Yes (subscription)

## Target Audience
- Primary: 13+ (teens and adults)
