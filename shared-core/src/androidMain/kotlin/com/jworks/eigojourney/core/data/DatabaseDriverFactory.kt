...
actual class DatabaseDriverFactory(private val context: Context) {
    actual fun createDriver(): SqlDriver {
        ...
        return AndroidSqliteDriver(
            schema = EigoJourneyDatabase.Schema,
            context = context,
            name = DB_NAME
        )
    }
        ...
        db.use {
            ...
            it.execSQL("""
                CREATE TABLE IF NOT EXISTS coin_sync_queue (
                    ...
                    source_business TEXT NOT NULL DEFAULT 'eigojourney',
    ...
    private fun ensureNewTables() {
        ...
        db.use {
            ...
            // Received words (cross-app: EigoLens → EigoJourney)
            it.execSQL("""
    ...
    companion object {
        private const val DB_NAME = "eigojourney.db"
    }
}
