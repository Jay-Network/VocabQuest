...
/**
 * J Coin earn trigger source_types for EigoJourney (source_business = "eigojourney").
...
object EarnTriggers {
    ...
    // Cross-app integration (EigoLens → EigoJourney)
    const val WORD_MASTERED = "eigojourney_word_mastered"   // 5 coins: mastered a received word (srs graduated)
